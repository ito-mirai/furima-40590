...
ActiveRecord::Schema[7.0].define(version: 2024_05_23_061549) do
  ...
  create_table "items", charset: "utf8", force: :cascade do |t|
    ...
    t.integer "ship_load_id", null: false
    t.integer "prefecture_id", null: false
  ...
  create_table "users", charset: "utf8", force: :cascade do |t|
    ...
    t.string "f_name_kana", default: "", null: false
    t.string "p_name_kana", default: "", null: false
